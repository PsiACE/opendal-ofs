...
use crate::Error;
use crate::data::{RangeBatch, RangeBatcher, RangeReader, VolumeAccess};
...
pub(crate) async fn install<A: VolumeAccess>(
...
async fn install_batch<A: VolumeAccess>(
    volume: &ManagedVolume<A>,
    workspace: &WorkContext,
...
async fn install_ranges<A: VolumeAccess>(
    volume: &ManagedVolume<A>,
    batch: RangeBatch<Installation>,
...
async fn install_file<A: VolumeAccess>(
    volume: &ManagedVolume<A>,
