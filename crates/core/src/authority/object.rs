...
use crate::Error;
use crate::format::{ExtensionDescriptor, RecordCodec};
use crate::storage::ControlRecord;

use super::{
    AuthorityHead, AuthorityId, AuthorityObservation, AuthorityRoot, AuthorityRoots,
    AuthorityStore, CollectionFence, DEFAULT_AUTHORITY,
};

const HEAD_KEY: &str = "managed/0/head";
const HEAD_RECORD: ControlRecord<AuthorityHead> =
    ControlRecord::new(HEAD_KEY, RecordCodec::new(*b"OFSHEAD0", 64 * 1024));

/// Core single-authority implementation.
#[derive(Clone, Copy, Debug, Default)]
pub struct DefaultAuthorityStore;

impl AuthorityStore for DefaultAuthorityStore {
