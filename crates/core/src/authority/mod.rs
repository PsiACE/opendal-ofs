...
//! Namespace authority store and root selection.
...
use crate::format::{ExtensionDescriptor, GcEpoch, NamespaceRevision};

pub use object::DefaultAuthorityStore;
pub use selector::{AuthoritySelector, DefaultSelector};
...
crate::format::codec::tuple_wire!(AuthorityHead {
...
/// Namespace authority store. Default and Branch implement this port.
pub trait AuthorityStore: Send + Sync + fmt::Debug + Unpin + 'static {
